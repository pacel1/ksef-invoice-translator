...
export const copy = {
  pl: {
    ...
    uploadHelpMulti: "Wgraj jedną lub wiele faktur FA(3) XML lub PDF.",
    uploadCta: "Wybierz pliki",
    uploadDropHint: "Przeciągnij pliki lub wybierz z dysku",
    uploadFormatHint: "Obsługujemy XML FA(3) i PDF KSeF (max 10 MB / plik)",
  ...
  en: {
    ...
    uploadHelpMulti: "Upload one or many FA(3) XML or PDF invoices.",
    uploadCta: "Choose files",
    uploadDropHint: "Drop files here or pick from disk",
    uploadFormatHint: "We accept FA(3) XML and KSeF PDF (max 10 MB / file)",
