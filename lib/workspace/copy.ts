...
export const copy = {
  pl: {
    ...
    duplicateContentRow: "Już raz wgrana — kontynuuj, aby dodać nowy język (bez opłaty jeśli język był już tłumaczony)",
  ...
  en: {
    ...
    duplicateContentRow: "Already uploaded — continue to add a new language (free if already translated to it)",
